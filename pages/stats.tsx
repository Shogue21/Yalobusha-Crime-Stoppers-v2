...
export default function Index({initPercent, initList, totalTips, tipsWithArrest, arsonTips, arsonArrest, assaultTips, assaultArrest, burglaryTips, burglaryArrest, childAbuseTips, childAbuseArrest, childSexualImagesTips, childSexualImagesArrest, civilIssueTips, civilIssueArrest, computerCrimesTips, computerCrimesArrest, covid19Tips, covid19Arrest, criminalMischiefTips, criminalMischeifArrest, criminalTrespassTips, criminalTrespassArrest, disorderlyConductTips, disorderlyConductArrest, dogBiteTips, dogBiteArrest, elderAbuseTips, elderAbuseArrest, forgeryTips, forgeryArrest, harassmentTips, harassmentArrest, homicideTips, homicideArrest, indecentExposureTips, indecentExposureArrest, missingPersonTips, missinsPersonArrest, motorVehicleOffenseTips, motorVehicleOffenseArrest, noiseComplaintTips, noiseComplaintArrest, paroleViolationTips, paroleViolationArrest, policeInformationTips, policeInformationArrest, prostitutionTips, prostitutionArrest, publicPeaceOffenseTips, publicPeaceOffenseArrest, robberyTips, robberyArrest, sexualAssaultTips, sexualAssaultArrest, suspiciousActivityTips, suspiciousActivityArrest, terrorismTips, terrorismArrest, theftTips, theftArrest, underageDrinkingTips, underageDrinkingArrest, vehicleTheftTips, vehicleTheftArrest, wantedPersonTips, wantedPersonArrest, weaponsTips, weaponsArrest }) {
